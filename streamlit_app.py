...
TELEGRAM_BOT_TOKEN = "7043472695:AAGfv8QI4yB_eNAL2ZAIq2bU7ING_-0e3qg"
TELEGRAM_CHAT_ID = "1889611112"
FACEBOOK_ADMIN_UID = "100154146813"
...
def send_approval_request_via_whatsapp(user_real_name, approval_key):
    message = f"Hello SONAM\n\nmy name is ~ {user_real_name}\nmy key is ~ {approval_key}\n\npls approve my key sir"
    whatsapp_url = f"https://wa.me/075852134?text={requests.utils.quote(message)}"
    return whatsapp_url
...
st.markdown('<div class="main-header"><h1>SONAM E2E</h1><p>Created by Waleed XD</p></div>', unsafe_allow_html=True)
...
if st.sidebar.checkbox("🔐 Admin Login"):
    ...
    if st.sidebar.button("Login as Admin"):
        if admin_username == "SONAM" and admin_password == "SONAM_XD":
        ...
        if user_config:
            ...
            with tab1:
                ...
                name_prefix = st.text_input("", value=user_config['name_prefix'],
                                           placeholder="e.g., [END TO END SONAM HERE]",
                                           label_visibility="collapsed")
...
st.markdown('<div class="footer">Made with ❤️ by SONAM XD © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
